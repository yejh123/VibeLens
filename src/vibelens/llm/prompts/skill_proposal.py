...
from vibelens.models.skill.skills import SkillProposalOutput

SKILL_PROPOSAL_PROMPT = AnalysisPrompt(
    task_id="skill_proposal",
    system_template=load_template("skill_proposal_system.j2"),
    user_template=load_template("skill_proposal_user.j2"),
    output_model=SkillProposalOutput,
)

SKILL_PROPOSAL_SYNTHESIS_PROMPT = AnalysisPrompt(
    task_id="skill_proposal_synthesis",
    system_template=load_template("skill_proposal_synthesis_system.j2"),
    user_template=load_template("skill_proposal_synthesis_user.j2"),
    output_model=SkillProposalOutput,
)
